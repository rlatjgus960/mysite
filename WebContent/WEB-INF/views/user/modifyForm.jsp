					...
					<div id="modifyForm">
						<form action="/mysite/user" method="">
							...
							<div class="form-group">
								<label class="form-text" for="input-uid">아이디</label> <span class="text-large bold">${uVo.id }</span>
							...
							<div class="form-group">
								<label class="form-text" for="input-pass">패스워드</label> <input type="text" id="input-pass"
									name="password" value="${uVo.pw }" placeholder="비밀번호를 입력하세요">
							</div>

							<!-- 이메일 -->
							<div class="form-group">
								<label class="form-text" for="input-name">이름</label> <input type="text" id="input-name"
									name="name" value="${uVo.name }" placeholder="이름을 입력하세요">
							</div>
							...
							<c:choose>
								<c:when test="${uVo.gender eq 'female' }">
